...
void INIT_SLIST_HEAD(struct slist_head *list)
{
	list->first.next = (struct slist_node *)0;
	list->last = &list->first;
}

void slist_add_head(struct slist_node *node,
...
void slist_add_tail(struct slist_node *node,
								  struct slist_head *list)
{
...
void slist_add_after(struct slist_node *node,
...
void slist_del_head(struct slist_head *list)
{
...
void slist_del_after(struct slist_node *prev,
								   struct slist_head *list)
{
...
int slist_empty(struct slist_head *list)
{
...
void slist_splice(struct slist_head *list,
								struct slist_node *at,
								struct slist_head *head)
{
	if (!slist_empty(list))
...
void slist_splice_init(struct slist_head *list,
									 struct slist_node *at,
									 struct slist_head *head)
{
	if (!slist_empty(list)) {
